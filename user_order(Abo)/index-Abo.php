...
<body>
    ...
    <div id="wrapper">
        ...
        >
          ...
          <li class="nav-item">
            <a
              class="nav-link collapsed text-shadow-20"
              href="#"
            ...
            >
              <div
                class="bg-white-transparency py-2 collapse-inner rounded text-shadow-20"
              >
          ...
          <li class="nav-item">
            ...
            <div
              id="collapseOrganizer"
              class="collapse"
              aria-labelledby="headingOrganizer"
              data-parent="#accordionSidebar"
            >
              <div
                class="bg-white-transparency py-2 collapse-inner rounded text-shadow-20"
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <span class="mr-3 d-none d-lg-inline text-gray-600 x-small"
                      >平台管理員</span
                    >
                    ...
                    >
                      <div class="left">
                        <div class="title py-1">
                          AI革新與智能化趨勢、5G技術帶動通信革命
                        </div>
                        <div class="time py-1">
                          2023-12-29 12:42:12 ~ 2023-12-29 15:35:35
                        </div>
                        <div class="number py-1">訂單編號:135435533525325</div>
                      </div>
                      <div class="right">
